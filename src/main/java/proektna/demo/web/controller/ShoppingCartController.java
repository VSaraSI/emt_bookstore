...
public class ShoppingCartController {
    ...
    public String getShoppingCartPage(HttpServletRequest req,
        ...
        model.addAttribute("bundles", this.shoppingCartService.listAllBundlesInShoppingCart(shoppingCart.getId()));
    ...
    public String deleteBundleFromShoppingCart(@PathVariable Long id,HttpServletRequest req, Authentication authentication) {
        User user = (User) authentication.getPrincipal();
        this.shoppingCartService.deleteBundleFromShoppingCart(user.getUsername(),id);
        return "redirect:/shopping-cart";
    }
    ...
    @PostMapping("/add-bundle/{id}")
    public String addBundleToShoppingCart(@PathVariable Long id, HttpServletRequest req, Authentication authentication) {
        try {
            User user = (User) authentication.getPrincipal();
            this.shoppingCartService.addBundleToShoppingCart(user.getUsername(), id);
